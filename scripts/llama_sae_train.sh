...
python save_activations.py \
  ...
  --dataset_name "imagenet" \
  --split "train" \
  --data_path "/root/lyt_dataset/imagenet1k" \
  --take_n_parquets 1 \
  --max_samples 512 \
  --num_workers 4 \
  --output_dir "./output/activations_smoke" \
  --save_every 256 \
  --device "cuda:0"
...
#python merge_activation_files.py \
#  --input_dir "./activations_dir/llama_activations"  # 包含 rank0/, rank1/ 等子目录
#  --output_dir "./activations_dir/llama_activations_merged" \
#  --mode "merge"
